//-----------------------------------------------------------------------
// <copyright file="WebApplicationWasmFactoryFixture.cs" company="lanedirt">
...
public class WebApplicationWasmFactoryFixture<TEntryPoint> : WebApplicationFactory<TEntryPoint>
