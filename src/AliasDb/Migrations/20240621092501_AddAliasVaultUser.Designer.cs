...
namespace AliasDb.Migrations
{
    ...
    [Migration("20240621092501_AddAliasVaultUser")]
    partial class AddAliasVaultUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AliasDb.AliasVaultUser", b =>
                {
            ...
            modelBuilder.Entity("AliasDb.AspNetUserRefreshToken", b =>
                {
                    b.HasOne("AliasDb.AliasVaultUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("AliasDb.AliasVaultUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
